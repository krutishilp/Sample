...
public class OrderRepositoryJDBCImpl implements OrderRepository {
	...
	public int updateParticularOrder(Order order) throws OrderNotFoundException {	
		try {
			pstmt = con.prepareStatement("update orders set orderName=?,orderPrice=?,orderQuantity=?,orderDate=? where orderId=?");
